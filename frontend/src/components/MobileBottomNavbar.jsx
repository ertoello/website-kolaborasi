...
import { Handshake, FileText, Users, Star } from "lucide-react";

const MobileBottomNavbar = ({ onLeftSidebarToggle, onRightSidebarToggle }) => {
  return (
    <div className="fixed bottom-0 left-0 w-full bg-[#3FA3CE] shadow-md border-t flex justify-around items-center p-1 lg:hidden z-40">
      ...
      >
        ...
        <span className="mt-1 text-xs">Rekomendas Teman</span>
      </button>
    </div>
  );
};
