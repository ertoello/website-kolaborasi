  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center py-2 px-4 w-full rounded-md bg-gray-200 dark:bg-gray-800 transition-colors mt-2"
      >
        <Settings size={20} />
      ...
      {settingsOpen && (
        <div className="absolute left-0 right-0 mt-2 bg-white dark:bg-gray-800 shadow-lg rounded-md p-2">
          <Link
            to="/edit-profile"
